...
# Теперь для каждого языка есть два направления: De->язык и язык->De
DIRECTIONS = {
    "auto_de": {
        "src": "auto",
        "dest": "de",
        "label": "🌐 → De (любой → немецкий)",
    },
...
STT_LOCALES = {
    "auto": "ru-RU",  # для авто → De считаем, что студенты чаще говорят по-русски
    "ru": "ru-RU",
    "de": "de-DE",
    "en": "en-US",
    "tr": "tr-TR",
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        ...
        "   • 🌐 → De — говоришь на своём языке (по умолчанию русский), получаешь немецкий.\n"
        "   • 🇩🇪 De-Русский / 🇷🇺 Русский-De\n"
        "   • 🇩🇪 De-English / 🇬🇧 English-De\n"
        "   • 🇩🇪 De-Türkçe / 🇹🇷 Türkçe-De\n"
        "   • 🇩🇪 De-Română / 🇷🇴 Română-De\n"
        "   • 🇩🇪 De-Polski / 🇵🇱 Polski-De\n"
        "   • 🇩🇪 De-العربية / 🇸🇾 العربية-De\n\n"
        ...
        "   • Перевод.\n"
        "   • Голосом озвучит перевод на целевом языке.\n\n"
        "4️⃣ Лимиты:\n"
...
async def handle_voice(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    src_label = "auto" if src_lang == "auto" else src_lang
    reply_text = (
